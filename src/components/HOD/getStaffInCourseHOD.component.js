...
class StaffInCourse extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/'+this.props.match.params.courseName +'/getStaffInCourse' ,{headers: { "auth-token": localStorage.getItem('auth-token') }})
      .then(response => {
    ...
    return (
        <div className={classes.background}>
                <CssBaseline />
                   ...
                   <h1 style={{margin:"auto"} }align="center" justify="right">Staff in Course</h1>
          <br/>
          <br/>
          <br/>
